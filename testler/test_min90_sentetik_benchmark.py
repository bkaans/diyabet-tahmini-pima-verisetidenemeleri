...
from makine_ogrenmesi.kaynak.min90_sentetik_benchmark import min90_benchmark_calistir


def test_min90_benchmark_source_id_guvenli_csv_ve_json_uretmeli(tmp_path: Path) -> None:
    ...
    csv_yolu = (
        ...
        / "veri"
        / "deneysel"
        / "min90_sentetik_430_per_class_pima.csv"
    )
    meta_yolu = csv_yolu.with_name("min90_sentetik_430_per_class_pima_metadata.csv")
    ...
    assert (
        ...
        / "makine_ogrenmesi"
        / "raporlar"
        / "min90_final_optimizasyon_sonuclari.json"
    ).exists()
