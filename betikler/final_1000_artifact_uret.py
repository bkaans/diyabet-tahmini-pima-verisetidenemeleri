...
RANDOM_STATE = 42
DATASET_ADI = "small_t1000_s0p6_adaptive"
DATASET_YOLU = PROJE_KOKU / "makine_ogrenmesi" / "veri" / "deneysel" / "min90_small_scale" / f"{DATASET_ADI}.csv"
METADATA_YOLU = PROJE_KOKU / "makine_ogrenmesi" / "veri" / "deneysel" / "min90_small_scale" / f"{DATASET_ADI}_metadata.csv"
SELECTION_RAPORU = PROJE_KOKU / "makine_ogrenmesi" / "raporlar" / "min90_small_scale_selection_report.json"
SWEEP_RAPORU = PROJE_KOKU / "makine_ogrenmesi" / "raporlar" / "min90_small_scale_sweep_results.json"
...
def main() -> None:
    ...
    kaydedilenler = artifactleri_kaydet(
        ...
        model_metadata={
            ...
            "mod": "final_1000_source_id_kontrollu_sentetik_benchmark",
