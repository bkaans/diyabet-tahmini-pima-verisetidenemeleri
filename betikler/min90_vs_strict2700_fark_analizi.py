"""Strict 2700 ve min90 2500 sentetik benchmark fark analizi."""
...
def main() -> None:
    ...
    min90_2500 = _dataset_from_files("min90_sentetik_2500_per_class_pima", 2500)
    ...
    cross_results = {
        ...
        "strict_xgb_no_skin_on_min90_2500": _eval("strict_xgb_no_skin_on_min90_2500", min90_2500, no_skin, strict_xgb),
        "new_soft_all_on_strict2700": _eval("new_soft_all_on_strict2700", strict2700, all_features, new_soft),
        "new_soft_all_on_min90_2500": _eval("new_soft_all_on_min90_2500", min90_2500, all_features, new_soft),
    }
    feature_effect = {
        ...
        "new_soft_min90_2500_all_vs_no_skin": {
            "all_features": cross_results["new_soft_all_on_min90_2500"],
            "no_skinthickness": _eval("new_soft_no_skin_on_min90_2500", min90_2500, no_skin, new_soft),
        },
    }
    threshold_effect = {
        name: {
    ...
    frames = {
        ...
        "min90_2500_all_rows": min90_2500.frame,
        "min90_2500_synthetic_only": _synthetic_only(min90_2500),
    ...
    generation_comparison = {
        ...
        "min90_2500": {
            "source": "makine_ogrenmesi/kaynak/min90_sentetik_benchmark.py",
            "target": "2500 / class",
            "methods": {
    ...
    old_on_new = cross_results["strict_xgb_no_skin_on_min90_2500"]["tuned_threshold_metrics"]
    new_on_old = cross_results["new_soft_all_on_strict2700"]["tuned_threshold_metrics"]
    new_on_new = cross_results["new_soft_all_on_min90_2500"]["tuned_threshold_metrics"]
    ...
    min90_sep = distribution["min90_2500_all_rows"]["class_separation"]["aggregate"]["mean_abs_cohens_d"]
    strict_shift = distribution_shift["strict2700_all_rows"]["aggregate"]["avg_abs_z_mean_shift"]
    min90_shift = distribution_shift["min90_2500_all_rows"]["aggregate"]["avg_abs_z_mean_shift"]

    conclusion = {
        "farkin_ana_nedeni": (
            "Ana fark modelden cok veri uretiminden geliyor. Min90 uretimi parent satiri sinif hedef merkezlerine "
        ...
        "model_etkisi_min90_data_delta": model_effect_new_data,
        ...
        "synthetic_distribution_shift": {
            ...
            "min90_2500_avg_abs_z_shift": min90_shift,
            "strict2700_mean_abs_cohens_d": strict_sep,
            "min90_2500_mean_abs_cohens_d": min90_sep,
            "var_mi": bool(min90_shift > strict_shift * 1.25 or min90_sep > strict_sep * 1.25),
        },
        "rapor_dili": (
    ...
    report = {
        "created_for": "strict2700 vs min90_2500 fark analizi",
    ...
    out = CIKTILAR / "min90_vs_strict2700_fark_analizi.json"
    ...
    print(
        "- Model etkisi:",
        f"strict veri üzerinde delta = {model_effect_old_data:.4f}; min90 veri üzerinde delta = {model_effect_new_data:.4f}",
    )
    ...
    print(
        ...
        f"(strict shift={strict_shift:.3f}, min90 shift={min90_shift:.3f})",
    )
